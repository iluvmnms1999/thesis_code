...
png("figures/ch3/output_fig/fig3_9.png", width = 6, height = 5, units = "in",
    res = 600)
meds_df |>
  ggplot() +
  ...
  geom_vline(data = med_vals,
             ...
             lty = "dashed",
             show.legend = FALSE) +
  annotate("text", x = med_vals$median[1] - .08, y = 11.8, col = "orange",
           label = paste0("median = ", round(med_vals$median[1], 2)),
           size = 3.5) +
  annotate("text", x = med_vals$median[2] + .08, y = 6.5, col = "blue",
