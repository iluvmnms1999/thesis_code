...
saveRDS(usgs_fs_cl, "data-raw/usgs_fs/usgs_fs_alm_v2.RDS")
...
usgs_fs_cl <- readRDS("data-raw/usgs_fs/usgs_fs_alm2.RDS")
data.table::setDT(usgs_fs_cl)
...
saveRDS(usgs_fs_miss, "data-raw/usgs_fs/usgs_fs_miss_corr_v2.RDS")
